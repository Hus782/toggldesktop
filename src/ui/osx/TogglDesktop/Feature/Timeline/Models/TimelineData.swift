...
final class TimelineData {
    ...
    init(cmd: TimelineDisplayCommand, zoomLevel: TimelineDatasource.ZoomLevel, runningTimeEntry: TimeEntryViewItem?, draggingCreatedTimeEntry: TimelineTimeEntryPlaceholder? = nil) {
        ...
        if let draggingEntry = draggingCreatedTimeEntry {
            self.timeEntries.append(draggingEntry)
        }
